...
set(:postgresql_pid, "/var/run/postgresql/16-main.pid")
...
namespace :postgresql do
  ...
  task :setup do
    on roles(:db) do |host|
      ...
      restart_db = template("postgresql/pg_hba.conf", "/etc/postgresql/16/main/pg_hba.conf", as: "postgres", group: "postgres", mode: "0640")

      restart_db = template("postgresql/postgresql.conf", "/etc/postgresql/16/main/postgresql.conf", as: "postgres", group: "postgres", mode: "0640") || restart_db
